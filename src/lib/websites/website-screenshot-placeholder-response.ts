...
<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="720" viewBox="0 0 1280 720" role="img" aria-label="Preview unavailable">
  ...
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#71717a" font-family="system-ui,Segoe UI,sans-serif" font-size="22">Preview unavailable</text>
</svg>`;
